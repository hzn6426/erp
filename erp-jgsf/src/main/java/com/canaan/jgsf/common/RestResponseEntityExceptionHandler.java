...
//	protected ResponseEntity<Object> handler404(NoHandlerFoundException ex, WebRequest request) {
...
//		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(mv);
////        return handleExceptionInternal(ex, mv, 
////          new HttpHeaders(), HttpStatus.CONFLICT, request);
//	}
//	
//	@ExceptionHandler(Exception.class)
//	protected ResponseEntity<Object> handleCustomerException(Exception ex, WebRequest request) {
...
//		
//		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(mv);
////        return handleExceptionInternal(ex, mv, 
////          new HttpHeaders(), HttpStatus.CONFLICT, request);
//    }
//	
