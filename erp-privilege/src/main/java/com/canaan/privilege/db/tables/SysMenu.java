...
public class SysMenu extends TableImpl<SysMenuRecord> {
    ...
    private static final long serialVersionUID = -1343375528;
    ...
    /**
     * The column <code>dubbo_test.sys_menu.code</code>.
     */
    public final TableField<SysMenuRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR.length(16), this, "");

    /**
     * The column <code>dubbo_test.sys_menu.name</code>.
     */
    public final TableField<SysMenuRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

    /**
     * The column <code>dubbo_test.sys_menu.url</code>.
     */
    public final TableField<SysMenuRecord, String> URL = createField("url", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");

    /**
     * The column <code>dubbo_test.sys_menu.parent_id</code>.
     */
    public final TableField<SysMenuRecord, Integer> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
